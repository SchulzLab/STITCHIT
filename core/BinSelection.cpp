...
void BinSelection::computeMeanSignal(std::string& chrom, const std::vector<std::pair<unsigned int, unsigned int> >& segments, const std::vector<unsigned int>& sVector){
...
unsigned int BinSelection::getNumberOfSignificantSegments(float threshold, std::vector<std::pair<double,double> > correlation){
	unsigned int counter = 0;
